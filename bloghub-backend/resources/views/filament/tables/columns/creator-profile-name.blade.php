...
<div style="display: flex; align-items: center; gap: 0.75rem; min-width: 0; max-width: 100%;">
    <div style="display: flex; height: 44px; width: 44px; align-items: center; justify-content: center; border-radius: 10px; background-color: #1f2937; font-size: 1.125rem; font-weight: 600; color: #f59e0b; overflow: hidden; flex-shrink: 0;">
        @if($avatarUrl)
