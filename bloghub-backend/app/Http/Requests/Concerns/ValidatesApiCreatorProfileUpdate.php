...
trait ValidatesApiCreatorProfileUpdate
{
    private const CREATOR_PROFILE_SLUG_REGEX = '/^[a-z0-9]+(?:-[a-z0-9]+)*$/';

    protected function creatorProfileApiUpdateRules(?CreatorProfile $profile): array
    {
        ...
        return [
            'slug' => [
                ...
                'max:255',
                $slugUnique,
                'regex:'.self::CREATOR_PROFILE_SLUG_REGEX,
            ],
    ...
    protected function creatorProfileApiUpdateMessages(): array
    {
        return [
