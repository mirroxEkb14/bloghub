        ...
        'Gordon Freeman' => [
            ...
            [
                'notes-from-the-test-chamber' => [
                    ...
                    'The chamber was silent before activation. It rarely is after. Documentation is the only defense against repeating the same experiment twice. These logs represent the raw, unfiltered data points collected during the pre-resonance phase, where every decibel and degree matters',
                    '3years',
                    3,
                ],
                'cascade-risk-assessment-model' => [
                    ...
                    "Risk is rarely about probability alone. It's about consequence multiplied by amplification potential. A small trigger can destabilize a closed system faster than expected. This model examines the specific thresholds where a minor anomaly becomes an unstoppable chain reaction",
                    '2years',
                    2,
                ],
                'lab-whiteboard-session' => [
                    ...
                    "Today's derivation focuses on nonlinear response curves in confined plasma systems. The chalk dust is optional. The math is not. We are looking at the exact moment where Newtonian physics hands the keys over to quantum uncertainty, and the results are... demanding",
                    '1year',
                    2,
                ],
                'resonance-cascade-theory-basics' => [
                    ...
                    'When energy systems are pushed beyond safe theoretical thresholds, the unknown is no longer abstract—it becomes measurable. I break down how resonance amplification works in closed environments and why containment models often fail under nonlinear loads. Proceed with caution',
                    '6months',
                    3,
                ],
                'advanced-particle-dynamics' => [
                    ...
                    'At extreme densities, classical intuition collapses. Predictive modeling must rely on probabilistic interpretation rather than deterministic expectation. This entry explores the behavior of subatomic particles when subjected to the concentrated force of a multi-stage accelerator',
                    '2months',
                    1,
                ],
                'microfractures-under-pressure' => [
                    ...
                    'Slow structural stress simulation. Watch where the fractures begin – not at the center, but along overlooked constraints. This entry explores the subtle transition from nominal operation to catastrophic failure within reinforced containment materials',
                    '3weeks',
                    2,
                ],
                'containment-door-mechanics' => [
                    ...
                    "Engineering is philosophy applied to steel. Every door, seal and barrier exists because someone predicted failure. We don't build them to keep things in; we build them to buy us time when the inevitable breach occurs. Here is the breakdown",
                    '1week',
                    null,
                ],
                'particle-accelerator-perspective' => [
                    ...
                    'A slow walkthrough of a circular acceleration tunnel. Scale matters. Human intuition struggles to grasp infrastructure built for subatomic phenomena. This log details the sheer physical magnitude required to influence the smallest building blocks',
                    '3days',
                    1,
                ],
                'theoretical-bridge-between-dimensions' => [
                    ...
                    'Speculative but mathematically grounded: what would a stable energy bridge require? Short answer – symmetry, balance, and far more power than we comfortably control. This is a look into the dark math of multi-dimensional folding and transit',
                    'yesterday',
                    3,
                ],
                'acoustic-profile-of-reactor-room' => [
                    ...
                    'Ambient recording from a high-energy reactor chamber. Even sound reveals system stress if you know what to listen for – subtle harmonic shifts precede mechanical failure. This entry analyzes the "song" of the machine under heavy load',
                    'today',
                    2,
                ],
                'containment-failure-simulation' => [
                    ...
                    'A short simulation showing how cascading overload propagates through a segmented energy chamber. Notice how the weakest structural boundary defines the outcome. This is a visual and data-driven study of how we lose control',
                    '5days',
                    null,
                ],
                'lab-notes-on-energy-instability' => [
                    ...
                    'Instability rarely announces itself dramatically. It begins as deviation – minor fluctuations that appear statistically irrelevant. Monitoring variance is more important than chasing anomalies. These notes cover the early warning signs of a system',
                    '2weeks',
                    1,
                ],
                'quantum-field-visualization' => [
                    ...
                    'A simplified visualization of quantum field interactions. Think less of particles as objects and more as disturbances propagating through structured fields. The math is elegant. The consequences are not always. A look at the unseen',
                    '4months',
                    null,
                ],
            ],
