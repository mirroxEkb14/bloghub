    ...
    <div className="page-center">
      <div className="card legal-page">
        ...
        <div className="legal-content">
          ...
          <p>
            <strong>Data we store.</strong> When you register and use BlogHub, we store account data,
            creator profile data, posts, comments, and subscription information. Payment data is handled by
            the payment provider you configure (e.g. Stripe), not stored by BlogHub beyond what is needed to
            link subscriptions to your account.
          </p>
          <p>
          ...
          <p>
            <strong>Security.</strong> You are responsible for securing the machine and database where BlogHub
            runs. For local use, access is limited to whoever can reach that environment.
          </p>
          <p>
